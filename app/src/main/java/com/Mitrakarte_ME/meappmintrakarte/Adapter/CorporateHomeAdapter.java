...
public class CorporateHomeAdapter extends RecyclerView.Adapter<CorporateHomeAdapter.ViewHolder> {
    ...
    static  public CorporateHomeAdapter.OnItemClickListener onClickListener;

    public CorporateHomeAdapter(Context c, ArrayList<Category> catList, CorporateHomeAdapter.OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.corporate_catogaries, parent, false);

        return new CorporateHomeAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_all_product_corporate);

            textView = (TextView) itemView.findViewById(R.id.category_item_title_corporate);
            imageView = (ImageView)itemView.findViewById(R.id.category_item_image_corporate);
