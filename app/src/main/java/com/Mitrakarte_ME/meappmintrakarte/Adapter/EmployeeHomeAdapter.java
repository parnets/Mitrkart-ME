...
public class EmployeeHomeAdapter extends RecyclerView.Adapter<EmployeeHomeAdapter.ViewHolder> {
    ...
    static  public EmployeeHomeAdapter.OnItemClickListener onClickListener;

    public EmployeeHomeAdapter(Context c, ArrayList<Category> catList, EmployeeHomeAdapter.OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.employee_catogaries, parent, false);

        return new EmployeeHomeAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_all_product_emp);

            textView = (TextView) itemView.findViewById(R.id.category_item_title_emp);
            imageView = (ImageView)itemView.findViewById(R.id.category_item_image_emp);
