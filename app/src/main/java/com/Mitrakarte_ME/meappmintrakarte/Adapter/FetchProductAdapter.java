...
public class FetchProductAdapter extends RecyclerView.Adapter<FetchProductAdapter.ViewHolder>{
    ...
    public FetchProductAdapter(Context c, ArrayList<Category> catList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listallproductnew, parent, false);

        return new FetchProductAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.tvkh_mrp.setText(mcatList.get(position).getMrp());
...
//        holder.productdistriprice.setText(String.valueOf(numprice));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView textView,productdistriprice,textView2,tv_minus2,tv_plus2, tvkh_mrp,category_item_titleproductbox;
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_all_productproductall);
            btnaddcartnewproduct = (Button) itemView.findViewById(R.id.btnaddcartnewproductall);
            tv_minus2 = (TextView)itemView.findViewById(R.id.tv_minus2all);
            tv_plus2 = (TextView)itemView.findViewById(R.id.tv_plus2all);
            tv_num2 = (EditText)itemView.findViewById(R.id.tv_num2all);
            productdistriprice = (TextView)itemView.findViewById(R.id.productdistripriceall);
            textView = (TextView) itemView.findViewById(R.id.category_item_titleproductall);
           // category_item_titleproductbox = (TextView) itemView.findViewById(R.id.category_item_titleproductboxall);
            textView2= (TextView) itemView.findViewById(R.id.category_item_titleproductQuantityall);
            imageView = (ImageView)itemView.findViewById(R.id.category_item_imageproductall);
            tvkh_mrp= (TextView) itemView.findViewById(R.id.tvkh_mrp);
