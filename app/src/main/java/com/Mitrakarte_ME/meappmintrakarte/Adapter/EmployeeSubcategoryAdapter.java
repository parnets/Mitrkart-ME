...
public class EmployeeSubcategoryAdapter extends RecyclerView.Adapter<EmployeeSubcategoryAdapter.ViewHolder>{
    ...
    static  public EmployeeSubcategoryAdapter.OnItemClickListener onClickListener;

    public EmployeeSubcategoryAdapter(Context c, ArrayList<Category> catList, EmployeeSubcategoryAdapter.OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.employee_subcat, parent, false);

        return new EmployeeSubcategoryAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_subcat_cor = (CardView) itemView.findViewById(R.id.card_all_subcat_Emp);

            textView = (TextView) itemView.findViewById(R.id.subcategory_item_name_Emp);
            imageView = (ImageView)itemView.findViewById(R.id.subcategory_item_image_Emp);
