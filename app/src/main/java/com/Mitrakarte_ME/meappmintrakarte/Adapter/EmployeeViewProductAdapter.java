...
import com.Mitrakarte_ME.meappmintrakarte.Service.AddCartEmployee;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class EmployeeViewProductAdapter extends RecyclerView.Adapter<EmployeeViewProductAdapter.ViewHolder>{
    ...
    static  public EmployeeViewProductAdapter.OnItemClickListener onClickListener;

    public EmployeeViewProductAdapter(Context c, ArrayList<Category> catList, EmployeeViewProductAdapter.OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.employee_productcatview, parent, false);

        return new EmployeeViewProductAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.tvepv_mrp.setText(mcatList.get(position).getMrp());
...
*/
                ...
                //Todo : Add Product to Employee Cart
                AsyncTask<Context, Void, Integer> result2 = new AddCartEmployee().execute(mContext);
                try {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView textView,productQuantity,product_pricetxt,productdistribox,tv_minus5,tv_plus5, tvepv_mrp;
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_productview_employee);
            //productdistribox = (TextView) itemView.findViewById(R.id.productdistribox9);
            textView = (TextView) itemView.findViewById(R.id.product_viewtxt_emp);
            product_pricetxt =itemView.findViewById(R.id.product_pricetxt_emp);
            imageView = (ImageView)itemView.findViewById(R.id.product_viewimg_emp);
            btnaddcartnew = (Button) itemView.findViewById(R.id.btn_addcart_employee);
            tv_plus5  =(TextView)itemView.findViewById(R.id.tv_plus9_emp);
            tv_num = (EditText) itemView.findViewById(R.id.tv_num9_emp);
            tv_minus5 = (TextView) itemView.findViewById(R.id.tv_minus9_emp);
            rlBtn = (LinearLayout) itemView.findViewById(R.id.rlBtn9_emp);
            productQuantity = (TextView) itemView.findViewById(R.id.product_Quantity_emp);
            tvepv_mrp = (TextView) itemView.findViewById(R.id.tvepv_mrp);
