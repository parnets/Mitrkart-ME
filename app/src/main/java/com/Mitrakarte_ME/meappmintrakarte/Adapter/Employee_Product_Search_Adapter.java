...
public class Employee_Product_Search_Adapter   extends RecyclerView.Adapter<Employee_Product_Search_Adapter.ViewHolder> {
    ...
    static public Employee_Product_Search_Adapter.OnItemClickListener onClickListener;

    public Employee_Product_Search_Adapter(Context c, ArrayList<Category> catList, Employee_Product_Search_Adapter.OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public Employee_Product_Search_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_search_product_employee, parent, false);
        return new Employee_Product_Search_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Employee_Product_Search_Adapter.ViewHolder holder, final int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_all_productproduct4_search_emp);

            textView = (TextView) itemView.findViewById(R.id.category_item_titleproduct4_search_emp);
            textView2 = (TextView) itemView.findViewById(R.id.category_item_titleproductQuantity4_search_emp);
            imageView = (ImageView) itemView.findViewById(R.id.category_item_imageproduct4_search_emp);
            category_distriprice = (TextView) itemView.findViewById(R.id.category_distriprice_search_emp);
            tv_plus4 = (TextView) itemView.findViewById(R.id.tv_plus4_search_emp);
            tv_num4 = (EditText) itemView.findViewById(R.id.tv_num4_search_emp);

            tv_minus4 = (TextView) itemView.findViewById(R.id.tv_minus4_search_emp);
            btnaddcartnewproductsubcat = (Button) itemView.findViewById(R.id.btnaddcartnewproductsubcat_search_emp);
            tvp_mrp = (TextView) itemView.findViewById(R.id.tvp_mrp_search_emp);
