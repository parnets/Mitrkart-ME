...
public class KeyAccountSubcategoryAdapter extends RecyclerView.Adapter<KeyAccountSubcategoryAdapter.ViewHolder> {
    ...
    static  public KeyAccountSubcategoryAdapter.OnItemClickListener onClickListener;

    public KeyAccountSubcategoryAdapter(Context c, ArrayList<Category> catList, KeyAccountSubcategoryAdapter.OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.key_acccount_subcat, parent, false);

        return new KeyAccountSubcategoryAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_all_productnew2);

            textView = (TextView) itemView.findViewById(R.id.category_item_titlenew2);
            imageView = (ImageView)itemView.findViewById(R.id.category_item_imagenew2);
