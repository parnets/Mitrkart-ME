...
public class EmployeeDeleteCart extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"deleteCartEmployee");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (EmployeeViewcartActivity) params[0];


            System.out.println("jyo Category sending paramter  "+"mobile   "+ht_inst.getUser().getEmpMobile());
            System.out.println("jyo Category sending paramter  "+"employee_token   "+ht_inst.getUser().getEmployeeToken());
            System.out.println("jyo Category sending paramter  "+"cart_id    "+ht_inst.getCategory().getCart_id_emp());
