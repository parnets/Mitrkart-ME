...
import com.Mitrakarte_ME.meappmintrakarte.Activity.Corporate_Product_Search_Activity;
...
public class FetchProductSearch_Corporate   extends AsyncTask<Context, Void, Integer> {

    Corporate_Product_Search_Activity mContext;
    Integer result = 200;
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base + "searchproduct_corporate");
            ...
            postRequestParams.add(new BasicNameValuePair("token", String.valueOf(ht_inst.getUser().getCorporateToken())));
            postRequestParams.add(new BasicNameValuePair("user_id", String.valueOf(ht_inst.getUser().getCorporateId())));
            postRequestParams.add(new BasicNameValuePair("search", String.valueOf(ht_inst.getUser().getProduct_Search_cor())));

            System.out.println(" Product_search sending paramter " + "mobile " + ht_inst.getUser().getCrmobile());
            System.out.println(" Product_search sending paramter " + "token " + ht_inst.getUser().getCorporateToken());
            System.out.println(" Product_search sending paramter " + "user_id " + ht_inst.getUser().getCorporateId());
            System.out.println(" Product_search sending paramter " + "search " + ht_inst.getUser().getProduct_Search_cor());
