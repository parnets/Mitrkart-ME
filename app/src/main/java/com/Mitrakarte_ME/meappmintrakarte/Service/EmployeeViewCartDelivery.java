...
public class EmployeeViewCartDelivery extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            System.out.println("jyo Category sending paramter"+"emp_id"+ht_inst.getUser().getEmployeeId());
