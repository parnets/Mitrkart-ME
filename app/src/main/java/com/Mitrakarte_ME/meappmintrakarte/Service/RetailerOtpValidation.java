...
public class RetailerOtpValidation  extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... strings) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base + "verifyOtpRegistrationRetailer");

            AG ag_inst = AG.getInstance();

            List<NameValuePair> postRequestParams = new ArrayList<>();

            System.out.println("sun sending mob"+ag_inst.getUser().getMobile()+"sun otp"+ag_inst.getUser().getOtp());
            postRequestParams.add(new BasicNameValuePair("mobile", String.valueOf(ag_inst.getUser().getMobile())));
    ...
    private void parseResult(String response) {
        try {
            ...
            ag_inst.getUser().setUserId(post.getInt("retailer_id"));
            System.out.println("sun id"+ag_inst.getUser().getUserId());
            ag_inst.getUser().setUserToken(post.getString("retailer_token"));
            System.out.println("sun token"+ag_inst.getUser().getUserToken());
