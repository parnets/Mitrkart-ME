...
public class UpdateCartKeyAccountHome extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"updateCartKeyAccount");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (KeyAccount_ViewcartActivity) params[0];

            System.out.println("ViewcartActivity_update_cart        "+"mobile"+ht_inst.getUser().getkMobile());
            System.out.println("ViewcartActivity_update_cart     "+"keyaccount_token"+ht_inst.getUser().getKeyAccountToken());
            System.out.println("ViewcartActivity_update_cart        "+"cart_id"+ht_inst.getCategory().getCart_id());
            System.out.println("ViewcartActivity_update_cart      "+"pro_qnty"+ht_inst.getCategory().getQuantity());
            ...
            postRequestParams.add(new BasicNameValuePair("cart_id", String.valueOf(ht_inst.getCategory().getCart_id())));
            postRequestParams.add(new BasicNameValuePair("pro_qnty", String.valueOf(ht_inst.getCategory().getQuantity())));
