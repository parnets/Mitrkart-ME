...
import com.Mitrakarte_ME.meappmintrakarte.Activity.DeliverAddressActivity;
...
public class PlaceOrder extends AsyncTask<Context, Void, Integer> {

    DeliverAddressActivity mContext;
    Integer result = 200;
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"orderHistoryKeyAccount");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (DeliverAddressActivity) params[0];
            ...
            System.out.println("PlaceOrderActivity"+"keyaccount_id  "+ht_inst.getUser().getKeyAccountId());
            System.out.println("PlaceOrderActivity"+"mobile "+ht_inst.getUser().getkMobile());
            System.out.println("PlaceOrderActivity"+"keyaccount_token "+ht_inst.getUser().getKeyAccountToken());
...
/*
    ...
    private void parseResult(String response) {
        try {
            ...
            System.out.println("jyo failed order placing");
        }
