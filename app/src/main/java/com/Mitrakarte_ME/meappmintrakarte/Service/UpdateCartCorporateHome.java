...
public class UpdateCartCorporateHome  extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"updateCartCorporate");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (CorporateViewcartActivity) params[0];

            System.out.println("ViewcartActivity_update_cart        "+"mobile   "+ht_inst.getUser().getCrmobile());
            System.out.println("ViewcartActivity_update_cart     "+"corporate_token   "+ht_inst.getUser().getCorporateToken());
            System.out.println("ViewcartActivity_update_cart        "+"cart_id    "+ht_inst.getCategory().getCart_id_cor());
            System.out.println("ViewcartActivity_update_cart      "+"pro_qnty   "+ht_inst.getCategory().getQuantity_cor());
            ...
            postRequestParams.add(new BasicNameValuePair("pro_qnty", String.valueOf(ht_inst.getCategory().getQuantity_cor())));
