...
public class MEOtpValidation extends AsyncTask<String, Void, Integer>{
    ...
    private void parseResult(String response) {
        try {
            ...
            ag_inst.getUser().setUserId(post.getInt("me_id"));
            System.out.println("sun id"+ag_inst.getUser().getUserId());
            ag_inst.getUser().setUserToken(post.getString("me_token"));
