...
import com.Mitrakarte_ME.meappmintrakarte.Activity.EmployeeHomeActivity;
...
public class AddCartEmployeeHome extends AsyncTask<Context, Void, Integer> {

   // EmployeeHomeActivity mContext;
    Integer result = 200;
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
           ...
           // mContext = (EmployeeHomeActivity) params[0];
