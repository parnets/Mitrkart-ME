...
public class KeyAccountOtpVlidation extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... strings) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base + "verifyOtpRegistrationKeyAcccount");
            ...
            //Todo: Changes
            System.out.println("sun sending mob"+ag_inst.getUser().getkMobile()+"sun otp"+ag_inst.getUser().getOtp());
            postRequestParams.add(new BasicNameValuePair("mobile", String.valueOf(ag_inst.getUser().getkMobile())));
    ...
    private void parseResult(String response) {
        try {
            ...
            //Todo: Changes
            ag_inst.getUser().setKeyAccountId(post.getInt("keyaccount_id"));
            System.out.println("sun id"+ag_inst.getUser().getKeyAccountId());
            ag_inst.getUser().setKeyAccountToken(post.getString("keyaccount_token"));
            System.out.println("sun token"+ag_inst.getUser().getKeyAccountToken());
