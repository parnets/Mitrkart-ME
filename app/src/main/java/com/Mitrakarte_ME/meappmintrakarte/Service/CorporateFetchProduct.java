...
import com.Mitrakarte_ME.meappmintrakarte.Activity.CorporateProductViewActivity;
...
public class CorporateFetchProduct extends AsyncTask<Context, Void, Integer> {

    CorporateProductViewActivity mContext;
    Integer result = 200;
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"fetchproductCorporate");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (CorporateProductViewActivity) params[0];
            ...
            postRequestParams.add(new BasicNameValuePair("subcategory", String.valueOf(ht_inst.getCategory().getSub_catId())));


            System.out.println("jyo Category CorporateProductViewActivity_sending_paramter "+"category "+ht_inst.getCategory().getCatId());
            System.out.println("jyo Category CorporateProductViewActivity_sending_paramter "+"subcategory "+ht_inst.getCategory().getSub_catId());
            ...
            if((line = reader.readLine())!=null){
                System.out.println("jyo get fetch my subcategory_product response "+line);
            }
    ...
    private void parseResult(String response) {
        try {
            ...
            ht_inst.getAllproductListCorporate().clear();
            ...
            for (int i = 0; i < post1.length(); i++) {
                ...
                ht_inst.getAllproductListCorporate().add(catItem);

            }

            System.out.println("jyo number of subcategory_product fetched is "+ht_inst.getAllproductListCorporate().size());

        }
        catch (Exception e) {


            System.out.println("jyo failed  parse fetch subcategory_product");
