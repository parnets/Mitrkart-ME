...
public class EmployeeFetchSubCategories extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"fetchSubcategoryEmployee");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (EmployeeProductsActivity) params[0];

            System.out.println("jyo Category sending paramter"+"mobile"+ht_inst.getUser().getEmpMobile()+"keyaccount_token"+ht_inst.getUser().getEmployeeToken());
    ...
    private void parseResult(String response) {
        try {
            ...
            System.out.println("jyo number of category fetched is " + ht_inst.getAllSubCategorylistCorporate().size());
        } catch (Exception e) {
