...
public class KeyAccountAddCart extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            postRequestParams.add(new BasicNameValuePair("per_contactNo", String.valueOf(ht_inst.getUser().getMobile())));
            postRequestParams.add(new BasicNameValuePair("distri_Token", String.valueOf(ht_inst.getUser().getUserToken())));
            postRequestParams.add(new BasicNameValuePair("distri_id", String.valueOf(ht_inst.getUser().getUserId())));
            ...
            postRequestParams.add(new BasicNameValuePair("p_price", String.valueOf(ht_inst.getCategory().getDistributor_cost())));
