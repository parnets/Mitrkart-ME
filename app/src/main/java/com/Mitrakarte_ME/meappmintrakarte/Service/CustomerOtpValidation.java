...
public class CustomerOtpValidation extends AsyncTask<String, Void, Integer>{
    ...
    protected Integer doInBackground(String... strings) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base + "verifyOtpRegistrationCustomer");
    ...
    private void parseResult(String response) {
        try {
            ...
            ag_inst.getUser().setUserId(post.getInt("user_id"));
            System.out.println("sun id"+ag_inst.getUser().getUserId());
            ag_inst.getUser().setUserToken(post.getString("token"));
