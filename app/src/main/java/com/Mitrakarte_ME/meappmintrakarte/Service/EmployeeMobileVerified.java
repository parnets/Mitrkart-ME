...
public class EmployeeMobileVerified extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"validateMobileRegEmployee");
            ...
            //Todo: Changes
            System.out.println("sun mobile"+ag_inst.getUser().getEmpMobile());
            inParam.setMobile(ag_inst.getUser().getEmpMobile());
