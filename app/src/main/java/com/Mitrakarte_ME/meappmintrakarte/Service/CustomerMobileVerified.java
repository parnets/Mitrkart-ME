...
public class CustomerMobileVerified extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"validateMobileRegCustomer");
            ...
            //Todo: Changes
            System.out.println("sun mobile"+ag_inst.getUser().getMobile());
            inParam.setMobile(ag_inst.getUser().getMobile());
