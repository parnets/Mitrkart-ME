...
public class AddCartEmployee extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"addCartEmployee");
            ...
            System.out.println("jyo Category sending paramter"+"emp_id"+ht_inst.getUser().getEmployeeId()+"p_price"+ht_inst.getCategory().getCustomer_discount_price());
