...
public class PlaceOrderCorporate extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"orderHistoryCorporate");
            ...
            System.out.println("PlaceOrderActivity_cor "+"mobile "+ht_inst.getUser().getCrmobile());
            System.out.println("PlaceOrderActivity_cor "+"corporate_token "+ht_inst.getUser().getCorporateToken());
            System.out.println("PlaceOrderActivity_cor "+"corporate_id  "+ht_inst.getUser().getCorporateId());
