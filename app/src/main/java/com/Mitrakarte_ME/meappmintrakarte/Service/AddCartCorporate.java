...
public class AddCartCorporate extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"addCartCorporate");
            ...
            System.out.println("jyo Category sending paramter"+"cor_id"+ht_inst.getUser().getCorporateId()+"p_price"+ht_inst.getCategory().getCustomer_discount_price());
