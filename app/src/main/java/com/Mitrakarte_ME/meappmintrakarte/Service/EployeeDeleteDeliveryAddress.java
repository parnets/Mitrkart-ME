...
public class EployeeDeleteDeliveryAddress extends AsyncTask<Context, Void, Integer> {
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"deleteEmployeeaddress");
            ...
            System.out.println("DeleteDeliveryAddress"  +"employee_token  "+ht_inst.getUser().getEmployeeToken());
            System.out.println("DeleteDeliveryAddress  "+"employee_id  "+ht_inst.getUser().getEmployeeId());
            System.out.println("DeleteDeliveryAddress  "+"ea_id  "+ht_inst.getAddress().getAdr_emp_id());
            ...
            postRequestParams.add(new BasicNameValuePair("ea_id", String.valueOf(ht_inst.getAddress().getAdr_emp_id())));
