...
import com.Mitrakarte_ME.meappmintrakarte.Activity.KeyAccountHomeActivity;
...
public class FetchProduct extends AsyncTask<Context, Void, Integer> {

    KeyAccountHomeActivity  mContext;
    Integer result3 = 200;
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"fetchProduct");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (KeyAccountHomeActivity) params[0];
