...
import com.Mitrakarte_ME.meappmintrakarte.Activity.EmployeeProductsActivity;
...
public class EmployeeFetchCategoryProduct extends AsyncTask<Context, Void, Integer> {

    EmployeeProductsActivity mContext;
    Integer result3 = 200;
    ...
    protected Integer doInBackground(Context... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"fetchCategoryBasedProductEmployee");

            List<NameValuePair> postRequestParams = new ArrayList<>();
            mContext = (EmployeeProductsActivity) params[0];
            ...
            if((line = reader.readLine())!=null){
                System.out.println("jyo get fetch my category_product response "+line);
            }
    ...
    private void parseResult(String response) {
        try {
            ...
            System.out.println("jyo number of category_product fetched is "+ht_inst.getFetchcatproductlist().size());
