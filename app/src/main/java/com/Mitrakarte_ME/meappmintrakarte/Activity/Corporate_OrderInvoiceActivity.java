...
public class Corporate_OrderInvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corporate__order_invoice);
        ...
        mWebView = findViewById(R.id.webview_order_invoice_cor);
