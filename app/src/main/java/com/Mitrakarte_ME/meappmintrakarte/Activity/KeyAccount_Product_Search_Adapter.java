...
import com.Mitrakarte_ME.meappmintrakarte.Service.AddCartKeyAccountHome;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class KeyAccount_Product_Search_Adapter extends RecyclerView.Adapter<KeyAccount_Product_Search_Adapter.ViewHolder>{
    ...
    static public KeyAccount_Product_Search_Adapter.OnItemClickListener onClickListener;

    public KeyAccount_Product_Search_Adapter(Context c, ArrayList<Category> catList, KeyAccount_Product_Search_Adapter.OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public KeyAccount_Product_Search_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_search_product_keyaccount, parent, false);
        return new KeyAccount_Product_Search_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final KeyAccount_Product_Search_Adapter.ViewHolder holder, final int position) {
        ...
        holder.btnaddcartnewproductsubcat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AsyncTask<Context, Void, Integer> result2 = new AddCartKeyAccountHome().execute(mContext);
                try {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            card_all_product = (CardView) itemView.findViewById(R.id.card_all_productproduct4_search_k);

            textView = (TextView) itemView.findViewById(R.id.category_item_titleproduct4_search_k);
            textView2 = (TextView) itemView.findViewById(R.id.category_item_titleproductQuantity4_search_k);
            imageView = (ImageView) itemView.findViewById(R.id.category_item_imageproduct4_search_k);
            category_distriprice = (TextView) itemView.findViewById(R.id.category_distriprice_search_k);
            tv_plus4 = (TextView) itemView.findViewById(R.id.tv_plus4_search_k);
            tv_num4 = (EditText) itemView.findViewById(R.id.tv_num4_search_k);

            tv_minus4 = (TextView) itemView.findViewById(R.id.tv_minus4_search_k);
            btnaddcartnewproductsubcat = (Button) itemView.findViewById(R.id.btnaddcartnewproductsubcat_search_k);
            tvp_mrp = (TextView) itemView.findViewById(R.id.tvp_mrp_search_k);
