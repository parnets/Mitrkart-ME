...
import com.Mitrakarte_ME.meappmintrakarte.Service.CorporateGetlogin;
...
public class CorporateLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmobile =findViewById(R.id.login_id_corporate);
      //  mmobile.setText("6666666666");
        mPassword = findViewById(R.id.login_password_corporate);
      //  mPassword.setText("1234c");
        signup = findViewById(R.id.signUp_text_corporate);
        forgotpass = findViewById(R.id.forget_password);
        login = findViewById(R.id.login_corporate);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //todo:changes
                dg_inst.getUser().setCrmobile(mmobile.getText().toString());
                ...
                //todo:changes
                dg_inst.getUser().setCrPassword(mPassword.getText().toString());

                try {

                    AsyncTask<String, Void, Integer> result;
                    result = new CorporateGetlogin().execute(mmobile.getText().toString(),mPassword.getText().toString());
                    ...
                    if(code==201){
                        ...
                        Dbhelper.createVendorDbHelper(CorporateLoginActivity.this);
                        ...
                        Intent intent = new Intent(CorporateLoginActivity.this, CorporateHomeActivity.class);
                    ...
                    Toast.makeText(CorporateLoginActivity.this, "Application Fail to Login", Toast.LENGTH_SHORT).show();
                }
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent j = new Intent(CorporateLoginActivity.this, CorporateForgetPasswordActivity.class);
                  startActivity(j);
            }
        });
    }
    ...
    protected void onResume() {
        ...
        if(!ht_inst.getInitDone()) {
            Intent intent = new Intent(CorporateLoginActivity.this, FirstActivityAccountSelection.class);
