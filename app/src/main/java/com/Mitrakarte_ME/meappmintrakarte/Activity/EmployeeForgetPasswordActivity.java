...
import com.Mitrakarte_ME.meappmintrakarte.Service.EmployeeForgotpassword;

import java.util.regex.Matcher;

public class EmployeeForgetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetButton = findViewById(R.id.btn_confirm_emp);
        emailId = (EditText) findViewById(R.id.et_fg_email_emp);
        mobile = (EditText) findViewById(R.id.et_fg_mobile_emp);
        mtext = findViewById(R.id.tv_forgot_emp);
        back_text_login = findViewById(R.id.back_text_login_emp);
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!matcher.matches()) {
                    ...
                    dg_inst.getUser().setEmpePersonalMail(emailId.getText().toString());
                    ...
                    dg_inst.getUser().setEmpMobile(mobile.getText().toString());
                }
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            result = new EmployeeForgotpassword().execute(emailId.getText().toString());
                            ...
                            if (code == 201) {
                                ...
                                Intent intent = new Intent(EmployeeForgetPasswordActivity.this, EmployeeLoginActivity.class);
                                startActivity(intent);
                                finish();
                            }
                            else{
                            ...
                            Toast.makeText(EmployeeForgetPasswordActivity.this, "Application Fail to request email recovery", Toast.LENGTH_SHORT).show();
